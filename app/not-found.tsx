    ...
    <LandingLayout>
      <Section>
        ...
        <div className="space-y-4 flex flex-col">
          <Link href="/about">
            <div className=" flex items-center space-x-4 rounded-none border p-4 max-w-sm w-full hover:scale-105 transition-all duration-200 ease-in-out group">
              <Icons.User className="w-5 h-5 text-primary transition-all" />
              <div className="flex-1 space-y-1">
                <P className="font-medium text-foreground">About</P>
                <P>Learn more about who I am, what I do</P>
              </div>
          ...
          <Link href="/projects">
            <div className=" flex items-center space-x-4 rounded-none border p-4 max-w-sm w-full hover:scale-105 transition-all duration-200 ease-in-out group">
              ...
              <div className="flex-1 space-y-1">
                ...
                <P>Discover the projects I&apos;ve built</P>
              </div>
              <ArrowRightIcon className="w-5 h-5" />
            </div>
          </Link>
        ...
        <Link
          ...
          href="/"
        >
          <ArrowLeftIcon className="w-5 h-5 transform transition-transform duration-300 group-hover:-translate-x-0.25"></ArrowLeftIcon>{" "}
          Back to home
        </Link>
      </Section>
    </LandingLayout>
